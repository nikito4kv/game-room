...
// face-api.js — тяжёлая библиотека, нужна только при включённой вебкамере
// (enableWebcam). Грузим её динамически и один раз (кэш промиса), чтобы она НЕ
// попадала в бандл главной страницы, где вебкамера всегда выключена.
let faceapiPromise = null;
function loadFaceApi() {
  if (!faceapiPromise) {
    faceapiPromise = import('face-api.js').then((m) => (m && m.nets ? m : m.default));
  }
